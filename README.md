...
* [Fields2Cover](https://github.com/Fields2Cover/Fields2Cover) ⭐ 887 | 🐛 31 | 🌐 C++ | 📅 2026-09-04 - Robust and efficient coverage paths for autonomous agricultural vehicles.
...
* [iem](https://github.com/akrherz/iem) ⭐ 194 | 🐛 108 | 🌐 Python | 📅 2026-09-10 - Code that makes the Iowa Environmental Mesonet run.
...
* [MyJohnDeereAPI-OAuth2-Java-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-Java-Example) ⭐ 3 | 🐛 4 | 🌐 Java | 📅 2026-09-10 - Java MyJohnDeere API client example.
* [MyJohnDeereAPI-OAuth2-NodeJS-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-NodeJS-Example) ⭐ 3 | 🐛 25 | 🌐 JavaScript | 📅 2026-09-09 - Node.js MyJohnDeere API client example.
...
* [LiteFarm](https://github.com/LiteFarmOrg/LiteFarm) ⭐ 239 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-09 - LiteFarm is the world’s first community-led, not-for-profit, Farm management system
...
* [Awesome GIS](https://github.com/sshuair/awesome-gis) ⭐ 5,515 | 🐛 67 | 📅 2026-07-21 - Awesome GIS is a list collecting abundant GIS related sources.
...
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 822 | 🐛 124 | 🌐 Python | 📅 2026-09-10 - Plant phenotyping software using computer vision.
...
* [AgML](https://github.com/Project-AgML/AgML) ⭐ 335 | 🐛 15 | 🌐 Python | 📅 2026-09-09 - Centralized framework for agricultural machine learning.
