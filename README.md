...
* [Fields2Cover](https://github.com/Fields2Cover/Fields2Cover) ⭐ 864 | 🐛 33 | 🌐 C++ | 📅 2026-08-10 - Robust and efficient coverage paths for autonomous agricultural vehicles.
...
* [iem](https://github.com/akrherz/iem) ⭐ 193 | 🐛 107 | 🌐 Python | 📅 2026-08-14 - Code that makes the Iowa Environmental Mesonet run.
...
* [MyJohnDeereAPI-OAuth2-NodeJS-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-NodeJS-Example) ⭐ 3 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-14 - Node.js MyJohnDeere API client example.
...
* [JDLinkMachineDataAPI-OAuth2-CSharp-Example](https://github.com/JohnDeere/JDLinkMachineDataAPI-OAuth2-CSharp-Example) ⭐ 0 | 🐛 7 | 🌐 C# | 📅 2026-08-14 - CSharp JDLink Machine Data API client example.
...
* [farmOS](https://github.com/farmOS/farmOS) ⭐ 1,337 | 🐛 60 | 🌐 PHP | 📅 2026-07-16 - Web-based farm record keeping application built with Drupal and PHP.
...
* [LiteFarm](https://github.com/LiteFarmOrg/LiteFarm) ⭐ 233 | 🐛 34 | 🌐 JavaScript | 📅 2026-08-15 - LiteFarm is the world’s first community-led, not-for-profit, Farm management system
...
* [pyshp](https://github.com/GeospatialPython/pyshp) ⭐ 1,154 | 🐛 8 | 🌐 Python | 📅 2026-08-14 - Reads and writes ESRI Shapefiles in pure Python.
...
* [Farm-Data-Relay-System](https://github.com/timmbogner/Farm-Data-Relay-System) ⭐ 623 | 🐛 6 | 🌐 C | 📅 2026-01-29 - System using ESP-NOW, LoRa, and other protocols to transport sensor data in remote areas without relying on WiFi.
* [OpenWeedLocator](https://github.com/geezacoleman/OpenWeedLocator) ⭐ 489 | 🐛 18 | 🌐 Python | 📅 2026-08-15 - Open Source, low-cost, image-based weed detection device for in-crop and fallow scenarios.
...
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 817 | 🐛 130 | 🌐 Python | 📅 2026-08-14 - Plant phenotyping software using computer vision.
