...
* [Fields2Cover](https://github.com/Fields2Cover/Fields2Cover) ⭐ 876 | 🐛 33 | 🌐 C++ | 📅 2026-08-29 - Robust and efficient coverage paths for autonomous agricultural vehicles.
...
* [iem](https://github.com/akrherz/iem) ⭐ 194 | 🐛 107 | 🌐 Python | 📅 2026-08-29 - Code that makes the Iowa Environmental Mesonet run.
...
* [SoybeanYield](https://github.com/saeedkhaki92/CNN-RNN-Yield-Prediction?tab=readme-ov-file) ⭐ 164 | 🐛 11 | 🌐 Python | 📅 2024-03-14 - A multimodal agricultural dataset for soybean yield forecasting, integrating yield performance, management practices, weather data, and soil parameters.
...
* [Botanica](https://github.com/Michael-A-Kuykendall/botanica) ⭐ 20 | 🐛 0 | 🌐 HTML | 📅 2026-08-28 - Production-ready Rust crate for professional botanical data management with taxonomic hierarchy, cultivation tracking, and Darwin Core compliance.
...
* [JDLinkMachineDataAPI-OAuth2-CSharp-Example](https://github.com/JohnDeere/JDLinkMachineDataAPI-OAuth2-CSharp-Example) ⭐ 0 | 🐛 7 | 🌐 C# | 📅 2026-08-29 - CSharp JDLink Machine Data API client example.
...
* [farmOS](https://github.com/farmOS/farmOS) ⭐ 1,343 | 🐛 62 | 🌐 PHP | 📅 2026-08-27 - Web-based farm record keeping application built with Drupal and PHP.
...
* [LiteFarm](https://github.com/LiteFarmOrg/LiteFarm) ⭐ 238 | 🐛 35 | 🌐 JavaScript | 📅 2026-08-28 - LiteFarm is the world’s first community-led, not-for-profit, Farm management system
...
* [Awesome GIS](https://github.com/sshuair/awesome-gis) ⭐ 5,506 | 🐛 64 | 📅 2026-07-21 - Awesome GIS is a list collecting abundant GIS related sources.
...
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 819 | 🐛 135 | 🌐 Python | 📅 2026-08-25 - Plant phenotyping software using computer vision.
