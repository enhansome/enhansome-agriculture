# Awesome Agriculture with stars
...
Contributions welcome! Please follow the [contributing guidelines](https://github.com/beaorn/awesome-agriculture/blob/master/contributing.md) ⭐ 1,854 | 🐛 12 | 📅 2026-01-05.
...
* [Fields2Cover](https://github.com/Fields2Cover/Fields2Cover) ⭐ 860 | 🐛 32 | 🌐 C++ | 📅 2026-08-10 - Robust and efficient coverage paths for autonomous agricultural vehicles.
...
* [farm-calculators](https://github.com/brycejohnston/farm-calculators) ⭐ 23 | 🐛 0 | 🌐 PHP | 📅 2017-05-01 - WordPress plugin for calculating various farming and crop related information.

## Climate, Environment and Weather

* [iem](https://github.com/akrherz/iem) ⭐ 193 | 🐛 107 | 🌐 Python | 📅 2026-08-12 - Code that makes the Iowa Environmental Mesonet run.
...
* [pyTSEB](https://github.com/hectornieto/pyTSEB) ⭐ 168 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-06-05 - A python two source energy balance model for estimation of evapotranspiration with remote sensing data.
* [frostline](https://github.com/waldoj/frostline) ⭐ 165 | 🐛 13 | 🌐 Python | 📅 2025-11-11 - A dataset, API, and python parser for USDA plant hardiness zones.
* [soilDB](https://github.com/ncss-tech/soilDB) ⭐ 100 | 🐛 29 | 🌐 R | 📅 2026-07-15 - R library for simplified access to NCSS soil databases.
* [GSODR](https://github.com/ropensci/GSODR) ⭐ 99 | 🐛 0 | 🌐 R | 📅 2026-05-17 - Global summary daily weather data in R.
* [agroclimatology](https://github.com/brycejohnston/agroclimatology) ⭐ 19 | 🐛 1 | 🌐 Ruby | 📅 2017-08-30 - Ruby client for interacting with the NASA (POWER) Agroclimatology Web Resource.
...
* [CropHarvest](https://github.com/nasaharvest/cropharvest) ⭐ 236 | 🐛 37 | 🌐 Jupyter Notebook | 📅 2024-04-30 - Open source remote sensing dataset for global crop type mapping with 95,186 labeled datapoints from satellite imagery, supporting machine learning research for food security.
* [SoybeanYield](https://github.com/saeedkhaki92/CNN-RNN-Yield-Prediction?tab=readme-ov-file) ⭐ 165 | 🐛 11 | 🌐 Python | 📅 2024-03-14 - A multimodal agricultural dataset for soybean yield forecasting, integrating yield performance, management practices, weather data, and soil parameters.
* [CWFID](https://github.com/cwfid/dataset) ⭐ 161 | 🐛 0 | 📅 2015-04-20 - Dataset comprising field images, vegetation segmentation masks and crop/weed plant type annotations.
...
* [SampleData](https://github.com/JohnDeere/SampleData) ⭐ 38 | 🐛 0 | 📅 2023-03-29 - Sample datacards, shapefiles, and other files you can use for testing.
...
* [Botanica](https://github.com/Michael-A-Kuykendall/botanica) ⭐ 19 | 🐛 0 | 🌐 Rust | 📅 2026-07-29 - Production-ready Rust crate for professional botanical data management with taxonomic hierarchy, cultivation tracking, and Darwin Core compliance.
...
* [MyJohnDeereAPI-OAuth2-Java-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-Java-Example) ⭐ 3 | 🐛 10 | 🌐 Java | 📅 2026-08-11 - Java MyJohnDeere API client example.
* [MyJohnDeereAPI-OAuth2-NodeJS-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-NodeJS-Example) ⭐ 3 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-11 - Node.js MyJohnDeere API client example.
...
* [JDLinkMachineDataAPI-OAuth2-CSharp-Example](https://github.com/JohnDeere/JDLinkMachineDataAPI-OAuth2-CSharp-Example) ⭐ 0 | 🐛 7 | 🌐 C# | 📅 2026-08-11 - CSharp JDLink Machine Data API client example.
...
* [farmOS](https://github.com/farmOS/farmOS) ⭐ 1,336 | 🐛 60 | 🌐 PHP | 📅 2026-07-16 - Web-based farm record keeping application built with Drupal and PHP.
* [Tania](https://github.com/Tanibox/tania-core) ⭐ 817 | 🐛 37 | 🌐 Go | 📅 2026-03-03 - Free and open source farming management system for everyone built with Go and Vue.js.
* [Ekylibre](https://github.com/ekylibre/ekylibre) ⭐ 485 | 🐛 9 | 🌐 Ruby | 📅 2026-07-26 - Farm management information system for farmers and small enterprises built with Ruby on Rails and PostgreSQL/PostGIS.
* [LiteFarm](https://github.com/LiteFarmOrg/LiteFarm) ⭐ 233 | 🐛 34 | 🌐 JavaScript | 📅 2026-08-12 - LiteFarm is the world’s first community-led, not-for-profit, Farm management system
* [Soil Mate](https://github.com/Open-Source-Agriculture/soil_mate) ⭐ 26 | 🐛 7 | 🌐 Dart | 📅 2021-04-05 - Helper app designed to assist the collection of soil data.
...
* [Awesome GIS](https://github.com/sshuair/awesome-gis) ⭐ 5,473 | 🐛 55 | 📅 2026-07-21 - Awesome GIS is a list collecting abundant GIS related sources.
...
* [pyshp](https://github.com/GeospatialPython/pyshp) ⭐ 1,154 | 🐛 8 | 🌐 Python | 📅 2026-07-25 - Reads and writes ESRI Shapefiles in pure Python.
...
* [Farm-Data-Relay-System](https://github.com/timmbogner/Farm-Data-Relay-System) ⭐ 622 | 🐛 6 | 🌐 C | 📅 2026-01-29 - System using ESP-NOW, LoRa, and other protocols to transport sensor data in remote areas without relying on WiFi.
* [OpenWeedLocator](https://github.com/geezacoleman/OpenWeedLocator) ⭐ 488 | 🐛 18 | 🌐 Python | 📅 2026-07-17 - Open Source, low-cost, image-based weed detection device for in-crop and fallow scenarios.
* [OpenMinder](https://github.com/autogrow/openminder) ⭐ 46 | 🐛 1 | 🌐 Go | 📅 2018-06-14 - Open Source Rootzone Monitoring, API and open source hat for the RaspberryPi.
...
* [OpenFarm](https://github.com/openfarmcc/OpenFarm) ⚠️ Archived - A free and open database for farming and gardening knowledge built with Ruby on Rails.
* [Harvest Helper](https://github.com/damwhit/harvest_helper) ⭐ 88 | 🐛 22 | 🌐 Ruby | 📅 2023-06-06 -  Provides growing, harvesting and recipe information for the 45 plants in the database as well as a JSON API.

## Machine Learning and AI

* [FarmVibes.AI](https://github.com/microsoft/farmvibes-ai) ⭐ 886 | 🐛 39 | 🌐 Jupyter Notebook | 📅 2025-07-28 - Multi-Modal GeoSpatial ML Models for Agriculture and Sustainability.
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 813 | 🐛 130 | 🌐 Python | 📅 2026-08-12 - Plant phenotyping software using computer vision.
* [Crop Yield Prediction](https://github.com/JiaxuanYou/crop_yield_prediction) ⭐ 423 | 🐛 11 | 🌐 Python | 📅 2023-05-27 - Deep gaussian process for crop yield prediction based on remote sensing data.
* [AgML](https://github.com/Project-AgML/AgML) ⭐ 302 | 🐛 13 | 🌐 Python | 📅 2026-07-10 - Centralized framework for agricultural machine learning.
...
* [Deep Learning for Biologists with Keras](https://github.com/totti0223/deep_learning_for_biologists_with_keras) ⭐ 107 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2019-05-27 - Tutorials for deep learning based analysis (mainly) on biological relavent themes.

## Remote Sensing and Imagery

* [Raster Vision](https://github.com/azavea/raster-vision) ⭐ 2,237 | 🐛 46 | 🌐 Python | 📅 2026-06-04 - Deep learning for aerial/satellite imagery.
* [Awesome Sentinel](https://github.com/Fernerkundung/awesome-sentinel) ⭐ 581 | 🐛 3 | 📅 2025-02-20 - A curated list of awesome tools, tutorials and APIs related to data from the Copernicus Sentinel Satellites.
* [Sen2Agri](https://github.com/Sen2Agri/Sen2Agri-System) ⭐ 131 | 🐛 23 | 🌐 HTML | 📅 2020-11-23 - Software system processing high resolution satellite images for agricultural purposes.
* [Awesome Vegetation Index](https://github.com/px39n/Awesome-Vegetation-Index) ⭐ 84 | 🐛 0 | 📅 2023-03-09 - List of reference, applications of common Vegetation Indices for Multi-spectral, hyper-spectral and UAV images.
