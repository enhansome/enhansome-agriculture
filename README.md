...
Contributions welcome! Please follow the [contributing guidelines](https://github.com/beaorn/awesome-agriculture/blob/master/contributing.md) ⭐ 1,883 | 🐛 20 | 📅 2026-01-05.
...
* [Fields2Cover](https://github.com/Fields2Cover/Fields2Cover) ⭐ 896 | 🐛 33 | 🌐 C++ | 📅 2026-09-21 - Robust and efficient coverage paths for autonomous agricultural vehicles.
...
* [iem](https://github.com/akrherz/iem) ⭐ 194 | 🐛 108 | 🌐 Python | 📅 2026-09-21 - Code that makes the Iowa Environmental Mesonet run.
...
* [pyTSEB](https://github.com/hectornieto/pyTSEB) ⭐ 170 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-08-31 - A python two source energy balance model for estimation of evapotranspiration with remote sensing data.
...
* [soilDB](https://github.com/ncss-tech/soilDB) ⭐ 100 | 🐛 31 | 🌐 R | 📅 2026-09-18 - R library for simplified access to NCSS soil databases.
...
* [CropHarvest](https://github.com/nasaharvest/cropharvest) ⭐ 240 | 🐛 37 | 🌐 Jupyter Notebook | 📅 2024-04-30 - Open source remote sensing dataset for global crop type mapping with 95,186 labeled datapoints from satellite imagery, supporting machine learning research for food security.
* [CWFID](https://github.com/cwfid/dataset) ⭐ 163 | 🐛 0 | 📅 2015-04-20 - Dataset comprising field images, vegetation segmentation masks and crop/weed plant type annotations.
* [SoybeanYield](https://github.com/saeedkhaki92/CNN-RNN-Yield-Prediction?tab=readme-ov-file) ⭐ 163 | 🐛 9 | 🌐 Python | 📅 2024-03-14 - A multimodal agricultural dataset for soybean yield forecasting, integrating yield performance, management practices, weather data, and soil parameters.
...
* [MyJohnDeereAPI-OAuth2-Java-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-Java-Example) ⭐ 3 | 🐛 4 | 🌐 Java | 📅 2026-09-21 - Java MyJohnDeere API client example.
* [MyJohnDeereAPI-OAuth2-NodeJS-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-NodeJS-Example) ⭐ 3 | 🐛 25 | 🌐 JavaScript | 📅 2026-09-18 - Node.js MyJohnDeere API client example.
...
* [JDLinkMachineDataAPI-OAuth2-CSharp-Example](https://github.com/JohnDeere/JDLinkMachineDataAPI-OAuth2-CSharp-Example) ⭐ 0 | 🐛 7 | 🌐 C# | 📅 2026-09-20 - CSharp JDLink Machine Data API client example.
...
* [farmOS](https://github.com/farmOS/farmOS) ⭐ 1,355 | 🐛 57 | 🌐 PHP | 📅 2026-09-21 - Web-based farm record keeping application built with Drupal and PHP.
* [Tania](https://github.com/Tanibox/tania-core) ⭐ 820 | 🐛 37 | 🌐 Go | 📅 2026-03-03 - Free and open source farming management system for everyone built with Go and Vue.js.
...
* [LiteFarm](https://github.com/LiteFarmOrg/LiteFarm) ⭐ 242 | 🐛 33 | 🌐 JavaScript | 📅 2026-09-18 - LiteFarm is the world’s first community-led, not-for-profit, Farm management system
...
* [Awesome GIS](https://github.com/sshuair/awesome-gis) ⭐ 5,532 | 🐛 74 | 📅 2026-07-21 - Awesome GIS is a list collecting abundant GIS related sources.
...
* [OpenWeedLocator](https://github.com/geezacoleman/OpenWeedLocator) ⭐ 497 | 🐛 18 | 🌐 Python | 📅 2026-09-16 - Open Source, low-cost, image-based weed detection device for in-crop and fallow scenarios.
...
* [FarmVibes.AI](https://github.com/microsoft/farmvibes-ai) ⭐ 899 | 🐛 43 | 🌐 Jupyter Notebook | 📅 2026-09-09 - Multi-Modal GeoSpatial ML Models for Agriculture and Sustainability.
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 826 | 🐛 76 | 🌐 Python | 📅 2026-09-21 - Plant phenotyping software using computer vision.
...
* [AgML](https://github.com/Project-AgML/AgML) ⭐ 342 | 🐛 13 | 🌐 Python | 📅 2026-09-16 - Centralized framework for agricultural machine learning.
...
* [Raster Vision](https://github.com/azavea/raster-vision) ⭐ 2,242 | 🐛 45 | 🌐 Python | 📅 2026-06-04 - Deep learning for aerial/satellite imagery.
* [Awesome Sentinel](https://github.com/Fernerkundung/awesome-sentinel) ⭐ 584 | 🐛 4 | 📅 2025-02-20 - A curated list of awesome tools, tutorials and APIs related to data from the Copernicus Sentinel Satellites.
* [Sen2Agri](https://github.com/Sen2Agri/Sen2Agri-System) ⭐ 133 | 🐛 21 | 🌐 HTML | 📅 2020-11-23 - Software system processing high resolution satellite images for agricultural purposes.
